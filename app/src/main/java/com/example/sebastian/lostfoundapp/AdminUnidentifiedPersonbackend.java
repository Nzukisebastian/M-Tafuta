 ...
 */
public class AdminUnidentifiedPersonbackend extends AsyncTask<String,Void,String> {
    Context context;
    AlertDialog alertDialog;
    ProgressDialog progressDialog;
    ProgressDialog loading;
    AdminUnidentifiedPersonbackend(Context ctx){
        context = ctx;
    }
    @Override
    ...
    protected String doInBackground(String... params) {
        ...
        String update_url = "http://ictchops.me.ke/imageupload/updateunidentified.php";
        String delete_url = "http://ictchops.me.ke/imageupload/deleteunidentified.php";
        if(type.equals("add")){
            try{
