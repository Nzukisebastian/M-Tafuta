 ...
 */
public class FounditemadminBackend extends AsyncTask<String,Void,String> {
    Context context;
    AlertDialog alertDialog;
    ProgressDialog progressDialog;
    ProgressDialog loading;
    FounditemadminBackend(Context ctx){
        context = ctx;
    }
    @Override
    ...
    protected String doInBackground(String... params) {
        ...
        String update_url = "http://ictchops.me.ke/imageupload/updatefounditem.php";
        String delete_url = "http://ictchops.me.ke/imageupload/deletefounditem.php";
        if(type.equals("add")){
            try{
