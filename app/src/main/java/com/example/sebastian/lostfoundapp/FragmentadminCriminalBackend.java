 ...
 */
public class FragmentadminCriminalBackend extends AsyncTask<String,Void,String> {
    Context context;
    AlertDialog alertDialog;
    ProgressDialog progressDialog;
    ProgressDialog loading;
    FragmentadminCriminalBackend(Context ctx){
        context = ctx;
    }
    @Override
    ...
    protected String doInBackground(String... params) {
        ...
        String update_url = "http://ictchops.me.ke/imageupload/updateitem.php";
        String delete_url = "http://ictchops.me.ke/imageupload/deleteitem.php";
        if(type.equals("add")){
            try{
