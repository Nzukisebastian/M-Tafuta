...
public class RecyclerAdapterf extends RecyclerView.Adapter<RecyclerAdapterf.MyViewHolder> {

    List<Imagesf> imagesList;
    Context context;

    public RecyclerAdapterf(List<Imagesf> images, Context context) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.foundpropertylayout,parent,false);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        final Imagesf image=imagesList.get(position);
    ...
    public void addImages(List<Imagesf>images){
        for(Imagesf im : images){
            imagesList.add(im);
        }
