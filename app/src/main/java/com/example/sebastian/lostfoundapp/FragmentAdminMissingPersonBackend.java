 ...
 */
public class FragmentAdminMissingPersonBackend extends AsyncTask<String,Void,String> {
    Context context;
    AlertDialog alertDialog;
    ProgressDialog progressDialog;
    ProgressDialog loading;
    FragmentAdminMissingPersonBackend(Context ctx){
        context = ctx;
    }
    @Override
    ...
    protected String doInBackground(String... params) {
        ...
        String update_url = "http://ictchops.me.ke/imageupload/updatemissing.php";
        String delete_url = "http://ictchops.me.ke/imageupload/deletemissingperson.php";
        if(type.equals("add")){
            try{
