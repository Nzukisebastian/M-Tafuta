...
public class Fragmenttrace extends Fragment{
    private RecyclerView recyclerViews;
    private ProgressBar progressBar;
    private GridLayoutManager layoutManager;
    private ApiInterfacet apiInterfacet;
    RecyclerAdaptert adapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        apiInterfacet=ApiClientt.ApiClientt().create(ApiInterfacet.class);

        progressBar.setVisibility(View.VISIBLE);
        Call<List<DataResponset>> call=apiInterfacet.getImages(page_number,item_count);
        call.enqueue(new Callback<List<DataResponset>>() {
            @Override
            public void onResponse(Call<List<DataResponset>> call, Response<List<DataResponset>> response) {

                List<Imagest>images=response.body().get(1).getImages();
                adapter=new RecyclerAdaptert(images,getContext());
            ...
            @Override
            public void onFailure(Call<List<DataResponset>> call, Throwable t) {
